...
function cudnnGetTensorSizeInBytes(tensorDesc,size)
    checkstatus(ccall((:cudnnGetTensorSizeInBytes,libcudnn),cudnnStatus_t,(cudnnTensorDescriptor_t,Ptr{Csize_t}),tensorDesc,size))
end
...
function cudnnGetReductionIndicesSize(handle,reduceTensorDesc,aDesc,cDesc,sizeInBytes)
    checkstatus(ccall((:cudnnGetReductionIndicesSize,libcudnn),cudnnStatus_t,(cudnnHandle_t,cudnnReduceTensorDescriptor_t,cudnnTensorDescriptor_t,cudnnTensorDescriptor_t,Ptr{Csize_t}),handle,reduceTensorDesc,aDesc,cDesc,sizeInBytes))
end

function cudnnGetReductionWorkspaceSize(handle,reduceTensorDesc,aDesc,cDesc,sizeInBytes)
    checkstatus(ccall((:cudnnGetReductionWorkspaceSize,libcudnn),cudnnStatus_t,(cudnnHandle_t,cudnnReduceTensorDescriptor_t,cudnnTensorDescriptor_t,cudnnTensorDescriptor_t,Ptr{Csize_t}),handle,reduceTensorDesc,aDesc,cDesc,sizeInBytes))
end
...
function cudnnSetConvolution2dDescriptor_v4(convDesc,pad_h,pad_w,u,v,dilation_h,dilation_w,mode)
    checkstatus(ccall((:cudnnSetConvolution2dDescriptor_v4,libcudnn),cudnnStatus_t,(cudnnConvolutionDescriptor_t,Cint,Cint,Cint,Cint,Cint,Cint,cudnnConvolutionMode_t),convDesc,pad_h,pad_w,u,v,dilation_h,dilation_w,mode))
end

function cudnnSetConvolution2dDescriptor_v5(convDesc,pad_h,pad_w,u,v,dilation_h,dilation_w,mode,computeType)
    checkstatus(ccall((:cudnnSetConvolution2dDescriptor_v5,libcudnn),cudnnStatus_t,(cudnnConvolutionDescriptor_t,Cint,Cint,Cint,Cint,Cint,Cint,cudnnConvolutionMode_t,cudnnDataType_t),convDesc,pad_h,pad_w,u,v,dilation_h,dilation_w,mode,computeType))
end

function cudnnGetConvolution2dDescriptor_v4(convDesc,pad_h,pad_w,u,v,dilation_h,dilation_w,mode)
    checkstatus(ccall((:cudnnGetConvolution2dDescriptor_v4,libcudnn),cudnnStatus_t,(cudnnConvolutionDescriptor_t,Ptr{Cint},Ptr{Cint},Ptr{Cint},Ptr{Cint},Ptr{Cint},Ptr{Cint},Ptr{cudnnConvolutionMode_t}),convDesc,pad_h,pad_w,u,v,dilation_h,dilation_w,mode))
end

function cudnnGetConvolution2dDescriptor_v5(convDesc,pad_h,pad_w,u,v,dilation_h,dilation_w,mode,computeType)
    checkstatus(ccall((:cudnnGetConvolution2dDescriptor_v5,libcudnn),cudnnStatus_t,(cudnnConvolutionDescriptor_t,Ptr{Cint},Ptr{Cint},Ptr{Cint},Ptr{Cint},Ptr{Cint},Ptr{Cint},Ptr{cudnnConvolutionMode_t},Ptr{cudnnDataType_t}),convDesc,pad_h,pad_w,u,v,dilation_h,dilation_w,mode,computeType))
end
