...
typealias libraryPropertyType_t UInt32
...
typealias libraryPropertyType UInt32
const MAJOR_VERSION = (UInt32)(0)
const MINOR_VERSION = (UInt32)(1)
const PATCH_LEVEL = (UInt32)(2)
...
typealias cudnnReduceTensorStruct Void
typealias cudnnReduceTensorDescriptor_t Ptr{cudnnReduceTensorStruct}
...
typealias cudnnDeterminism_t UInt32
const CUDNN_NON_DETERMINISTIC = (UInt32)(0)
const CUDNN_DETERMINISTIC = (UInt32)(1)
...
typealias cudnnReduceTensorOp_t UInt32
const CUDNN_REDUCE_TENSOR_ADD = (UInt32)(0)
const CUDNN_REDUCE_TENSOR_MUL = (UInt32)(1)
const CUDNN_REDUCE_TENSOR_MIN = (UInt32)(2)
const CUDNN_REDUCE_TENSOR_MAX = (UInt32)(3)
...
typealias cudnnReduceTensorIndices_t UInt32
const CUDNN_REDUCE_TENSOR_NO_INDICES = (UInt32)(0)
const CUDNN_REDUCE_TENSOR_FLATTENED_INDICES = (UInt32)(1)
...
typealias cudnnIndicesType_t UInt32
const CUDNN_32BIT_INDICES = (UInt32)(0)
const CUDNN_64BIT_INDICES = (UInt32)(1)
const CUDNN_16BIT_INDICES = (UInt32)(2)
const CUDNN_8BIT_INDICES = (UInt32)(3)
...
zero(::Type{Array_4_Cint}) = begin  # /home/shindo/local-lemon/.julia/v0.4/Clang/src/wrap_c.jl, line 266:
...
typealias cudnnRNNAlgo_t UInt32
const CUDNN_RNN_ALGO_STANDARD = (UInt32)(0)
const CUDNN_RNN_ALGO_PERSIST_STATIC = (UInt32)(1)
const CUDNN_RNN_ALGO_PERSIST_DYNAMIC = (UInt32)(2)
...
typealias cudnnPersistentRNNPlan Void
typealias cudnnPersistentRNNPlan_t Ptr{cudnnPersistentRNNPlan}
